          ...
          <Card>
            <CardBody>
              <AdvanceServerSide
                ...
                exportUrl={`${crmURL}/finance/finance_dashboard/?type=overall`}
                isExport={true}
                // selectableRows={true}
              ...
              <div className="row">
                ...
                <div className="col-md-12">
                  <ComTable
                    ...
                    filteredData={setServicingFilteredData}
                  />
                  ...
                  <div className="pb-1 Finance">
                    <h5>Finance</h5>
                    <div className="main d-flex justify-content-start algin-items-center my-1 gap-1">
                      <div className="form-check d-flex align-items-center mx-0 p-0" style={{gap: '5px'}}>
                        <input checked={conflictDataInput?.finance_new} id="finance_new" type="checkbox" name='title' min="0" max="300" className='form-check-input m-0' onChange={(e) => setConflictDataInput({ ...conflictDataInput, finance_new: !conflictDataInput?.finance_new })} />
                        <label htmlFor='finance_new' style={{ fontSize: "0.85rem", width: '100%' }} className="form-check-label m-0 p-0">Create New</label>
                      </div>
                      <div className="form-check d-flex align-items-center mx-0 p-0" style={{gap: '5px'}}>
                        <input checked={conflictDataInput?.finance_overflow_write} id="finance_overflow_write" type="checkbox" name='title' min="0" max="300" className='form-check-input m-0' onChange={(e) => setConflictDataInput({ ...conflictDataInput, finance_overflow_write: !conflictDataInput?.finance_overflow_write })} />
                        <label htmlFor='finance_overflow_write' style={{ fontSize: "0.85rem", width: '100%' }} className="form-check-label m-0 p-0">Over Write</label>
                      </div>
                      {/* <div className="form-check d-flex align-items-center mx-0 p-0" style={{gap: '5px'}}>
                        <input id="finance_both" type="checkbox" name='title' min="0" max="300" className='form-check-input m-0' onChange={(e) => setConflictDataInput({ ...conflictDataInput, finance_both: !conflictDataInput?.finance_both })} />
                        <label htmlFor='finance_both' style={{ fontSize: "0.85rem", width: '100%' }} className="form-check-label m-0 p-0">Both</label>
                      </div> */}
                    </div>
