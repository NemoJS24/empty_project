    ...
    return (
        <>
            ...
            <div style={{ background: "#fff" }} className=' '>
                    ...
                    {/* Section 1 */}
                    <Container fluid='sm' className='mt160 ' >
                        <Row className=' justify-content-center'>
                            <Col md='12' lg="11" className='' >
                                <Row className=' ' >
                                    <Col md="7" className='d-flex justify-content-center flex-column align-items-start'>
                                        <div className=' text-center text-sm-start '>
                                            <h3 className='fs-3 fw-bolder  text-dark'>LEAD GENERATION</h3>
                                            <h1 className='display-1 lh-83 text-start main-heading fw-bolder'>
                                                Built to Convert
                                            </h1>
                                            <h1 className=' text-black  mt-1' >Strengthen your sales cycle with high-intent, verified leads.<br />
                    ...
                    <Container fluid='sm' className='mt180'>
                        ...
                        <h1 className='text-center text-black px-5 pt-0 pb-0' >A high-potential customer who willfully shares and verifies their contact information <br /> to receive an incentive, thus demonstrating a clear intent to purchase.</h1>
                        <Row className='justify-content-center  pt-5 ' >

                            <Col xs="10" md="4" className=' text-center main-heading  ' style={{ background: '' }}>
                            ...
                            <Col md="2" className='d-flex align-items-center justify-content-center' style={{ background: '' }}>
                                <h1 className='display-1 text-black d-flex ' style={{marginTop:"-75px"}}>
                                    <p>V</p>
                    ...
                    <div className='section5 d-flex justify-content-center align-items-center flex-wrap mt180'  >
                        <Container fluid='sm' className='' style={{ width: "100%", background: "#f2f2f2" }}>
                            <Row className=' justify-content-center'>
                                <Col md='10' className='  d-flex justify-content-center flex-column align-items-center p-5' style={{ background: "#f2f2f2" }}>
                                    <div className=' text-center text-sm-start ' >
                                        <h3 className='display-4  main-heading fw-bolder pt-5' >What is SuperLeadz?</h3>
                                        <h3 className='display-4 fw-bolder text-secondary pb-5' style={{ lineHeight: '1' }}>SuperLeadz generates 100% self-verified leads, tailors rewards to match visit frequency and engagement, and facilitates one-click offer redemptions for a frictionless purchase journey.</h3>
                                    </div>
                    ...
                    <Container fluid='sm' className='mt180'>
                        ...
                        <Row className='justify-content-center px-2 gap-1' >
                            ...
                            <Col xs="10" md="5" className='text-center border rounded headings-compact content-max-width font-size-normal p-2' style={{ background: '' }}>
                            ...
                            <Row className='  justify-content-center '>
                                {
                                    headingData.map((data, index) => (
                                        <Col md="5" >
                                            <CardLeft icon={data.icon} title={data.heading} desc={data.para} key={index} />
                    ...
                    <div className='d-flex flex-column gap-5 mt180'>
                        ...
                        <Row className='justify-content-center py-0 text-center ' >
                            <Col xs="10" md="12" xl="11" className=''>
                                <Container fluid='lg'>
                    ...
                    <div className='d-flex flex-column gap-5 mt-5 pt-5'>
                        ...
                        <Row className='justify-content-center py-0 text-center' >
                            <Col xs="10" md="12" xl="11" className=''>
                                ...
                                <h1 className='display-4 main-heading fw-bolder pt-5 '>Trace every lead’s journey through your store.</h1>
                                <h4 className='fs-1  text-black lh-32 pb-5'>Understand your leads by the choices they make. Stick to the sale with hot leads. Exclude marketing-averse leads .</h4>
                    ...
                    {/* SECTION 8 */}
                    <Container fluid='sm' className='px-0 px-md-5'>
                                ...
                                <Row className='  justify-content-center '>
                                    {
                                        smartData.map((data, index) => (
                                            <Col md="6" >
                                                <CardLeft icon={data.icon} title={data.p} desc={data.s} key={index} />
                    ...
                    <Container fluid='sm' className='mt160'>
                        <Row className=' justify-content-center align-items-center pb-5' style={{ background: '#000' }}>
                            ...
                            <Col xs="10" md="10" lg="11">
                                <Container fluid='sm' className='mt60'>
                                    <Row className='justify-content-center'>
                    ...
                    <Container fluid='sm' className='mt180'>
                        <Row className='mt180 justify-content-center px-2 pt-3 pb-3 gap-2' >
                            <h1 className='display-2  main-heading fw-bolder text-center mb-5'>Start for free and pay as you grow.</h1>
                            ...
                            <Col xs="10" md="5" className='text-start rounded headings-compact content-max-width font-size-normal  p-2' style={{ background: '#c9e8f5' }}>
                                <div className='d-flex justify-content-between' >
                    ...
                    <Container fluid='sm'>
                        <Row className=' justify-content-center mt170 '>
                            <Col lg="12" xl="10">
                                <Card className='shadow-none p-5 border overflow-hidden ' style={{ background: "#e5e7eb" }}>
                                    <Row>
                                        <Col md="6">
                                            ...
                                            <Link to='/products/superleadz/lead-generation-nurturing-and-conversion/features' className='btn  btn-lg  fs-3 main-btn-dark px-3 py-1'>Learn More <FiArrowUpRight className='fs-4' style={{ marginLeft: "3px", marginBottom: "2px" }} /></Link>
                                        </Col>
                        ...
                        <Row className='mt180 justify-content-center'>
                            <Col xs="11" md="11" className='text-center' >
                                <div className='' style={{ background: '#fff' }}>
                                    ...
                                    <Link to='/merchant/signup' className=' btn  btn-primary fs-4 mt-1 mb-1 fw-lig'>Get started for free</Link>
