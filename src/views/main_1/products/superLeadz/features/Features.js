          ...
          <Col xs="10" xl="10" className='  px-0 rounded-2'>
            <Row className='justify-content-center  match-height  h-100'>
              ...
              <Col md="6" className='overflow-hidden  p-0 m-0  d-flex justify-content-center align-items-center '>
                ...
                <img className=' rounded-2 ' src={gif1} alt="" style={{ width: "440px" }} />
              </Col>
            ...
            <div className='d-flex gap-5  justify-content-center mt-5 '>
              {
                nextgenData.map((data, index) => (
                  ...
                  <h1 onMouseEnter={() => { setActiveNextgen(index) }} className={`fw-bolder ms-3 cursor-pointer ${ActiveNextgen === index ? 'main-heading' : 'text-secondary'}`} >{data.title}</h1>
                ))
              }
            ...
            </div>
            {
              nextgenData.map((data, index) => {
                if (ActiveNextgen === index) {
                  return (
                    <>
                      <Row className='justify-content-center  match-height mt-2 border-bottom border-top '>
                        <Col lg="5" className='d-flex flex-column  gap-2 py-3'>
                          ...
                          <div>
                            ...
                            {
                              data.list.map((listData) => <h3 className='fs-3  text-black ' >{listData}</h3>
                              )
                            }
                          </div>
                        </Col>
                      ...
                      <Row className='mt-5 border-bottom pb-5 ' >
...

                        {
                          data.point.map((point) => (
                            <Col lg="6" className='mt-2' key={index} >
