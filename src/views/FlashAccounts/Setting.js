...
const Setting = ({ isAdmin = false }) => {
    ...
    const defaultTheme = {
        page_1: {
            ...
            sub_headingAf: "",
            sub_heading_colorAf: "rgba(0,0,0,1)",
            secondary_fontAf: "sans-serif",
            sub_heading_font_sizeAf: "24px",
            campaignStartDate: moment().format('YYYY-MM-DD HH:mm:ss'),
            ...
            email_settings: {
                ...
                htmlContent: "<p class=\"editor-paragraph\"><br></p>",
                subject: "Flash Account"
            }
        }
    }
        ...
        <>
          ...
          `}
                ...
                <div className='d-flex align-items-center justify-content-between px-0'>
                    <div className='d-flex justify-content-start align-items-cente'>
                  ...
                  toggle ? 'Deactivate Flash Accounts' : 'Activate Flash Accounts'
                    ...
                    <div className='d-flex flex-row justify-content-end align-items-center' style={{ padding: "0.5rem", gap: "0.5rem" }}>
                        <div className="d-flex justify-content-center align-items-center" style={{ gap: '15px', padding: '0px 10px' }}>
                            ...
                            </div>
                            {
                                sideNav === "Email" ? (
                                    <>
                                        <a className="btn btn-primary d-flex justify-content-center align-items-center" onClick={() => setSendTest(!sendTest)}><Send size='15' /><span className="mx-1" style={{ whiteSpace: 'nowrap' }}>Test Mail</span></a>
                                    </>
                                ) : ''
                            }
            ...
            <div className="d-flex justify-content-center align-items-stretch border position-relative" style={{ height: "calc(100vh - 55px)" }}>
                ...
                <div className="d-flex align-items-stretch flex-grow-1 h-100">
                                ...
                                <UncontrolledAccordion stayOpen defaultOpen={["1"]}>
                                    ...
                                    <AccordionItem>
                                        ...
                                        <AccordionBody accordionId='2'>
                                            ...
                                            <div className="py-1">
                                                <Col md={12} style={{ marginBottom: "1.25rem" }}>
                                                    <div className="form-check-success form-switch cursor-pointer d-flex">
                                    ...
                                    <AccordionItem>
                                        ...
                                        <AccordionBody accordionId='1'>
                                            ...
                                            <div className="py-1">
                                                ...
                                                <input value={prevData?.page_1?.email_settings?.subject} onChange={(e) => setCurrObj({ ...currObj, email_settings: { ...currObj.email_settings, subject: e.target.value } })} name="subject" type="text" className="form-control" id="subject" placeholder="Subject" />
                                            </div>
                    ...
                    <div id='preview-section-only' className="d-flex flex-column flex-grow-1 align-items-center bg-light-secondary position-relative" style={{ overflow: 'auto' }}>
                        <Row className="w-100">
                            {
                                sideNav !== "Email" ? (
                                    <>
                                                        ...
                                                        <div style={{ padding: '40px', border: 'solid 1px rgb(239, 239, 239)', boxShadow: '1px 1px 13px 3px rgba(0,0,0,0.05)', background: 'white', borderRadius: '10px', width: '500px', margin: "auto", wordBreak: "break-word" }}>
                                                            <div onClick={(e) => {
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div style={{ fontSize: prevData?.["page_1"]?.successsub_heading_font_size, fontWeight: 400, marginTop: '10px', color: 'rgb(91, 91, 91)', lineHeight: 'auto', color: prevData?.["page_1"]?.successsub_heading_color, fontFamily: prevData?.page_1?.successsecondary_font, whiteSpace: 'pre-wrap' }}>
