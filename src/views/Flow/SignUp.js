...
export default function FlowSignUp() {
    ...
    const passValid = (value) => {
        ...
        errors.specialChar = generateErrorMessage(!/(?=.*[@#$%^&*+=!])/g.test(value), 'Password must contain 1 special character')
                    ...
                    <Col md="10" xl="8" style={{width: '950px', maxWidth: '100%'}}>
                        <form className='mt-2 p-3' onSubmit={handleSubmit} >
                            ...
                            <div className='text-center my-3'>
                                <button type='submit' className='btn  main-btn-black btn-lg fs-4 px-5 fw-lig' onClick={handleSubmit}> Sign Up</button>
                            </div>
