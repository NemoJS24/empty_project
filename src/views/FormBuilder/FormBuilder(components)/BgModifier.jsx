    ...
    useEffect(() => {
        ...
        if (type === "btnStyles") {
            setMainStyle({
                ...mainStyle,
                backgroundStyles: {
                    ...mainStyle?.backgroundStyles,
                    button: {
                        ...mainStyle?.backgroundStyles.button,
                        ...bgStylesObj
                    },
                    mobile_button: {
                        ...mainStyle?.backgroundStyles.mobile_button,
                        ...bgStylesObj
                    }
                }
            })
            ...
            setMainStyle({
                ...mainStyle, // Spread the existing properties of mainStyle
                backgroundStyles: {
                    ...mainStyle?.backgroundStyles, // Spread the existing backgroundStyles object
                    main: {
                        ...mainStyle?.backgroundStyles.main, // Spread the existing main property
                        ...bgStylesObj // Spread the properties from bgStylesObj
                    },
                    mobile_main: {
                        ...mainStyle?.backgroundStyles.mobile_main, // Spread the existing mobile_main property
                        ...bgStylesObj // Spread the properties from bgStylesObj
                    }
                }
            })
                        ...
                        <div className="d-flex justify-content-center align-items-center" style={{ padding: "0.75rem" }}>
                            {
                                type === "btnStyles" ? (
                                    <>
                                        <div className={`${conditionVariable?.bgType === "none" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, button: { ...mainStyle?.backgroundStyles?.button, bgType: "none" }, mobile_button: { ...mainStyle?.backgroundStyles?.mobile_button, bgType: "none" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>None</div>
                                        <div className={`${conditionVariable?.bgType === "solid" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, button: { ...mainStyle?.backgroundStyles?.button, bgType: "solid" }, mobile_button: { ...mainStyle?.backgroundStyles?.mobile_button, bgType: "solid" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>Solid</div>
                                        <div className={`${conditionVariable?.bgType === "gradient" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, button: { ...mainStyle?.backgroundStyles?.button, bgType: "gradient" }, mobile_button: { ...mainStyle?.backgroundStyles?.mobile_button, bgType: "gradient" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>Gradient</div>
                                        <div className={`${conditionVariable?.bgType === "image" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, button: { ...mainStyle?.backgroundStyles?.button, bgType: "image" }, mobile_button: { ...mainStyle?.backgroundStyles?.mobile_button, bgType: "image" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>Image</div>
                                    </>
                                ) : type === "bgStyles" ? (
                                    <>
                                        <div className={`${conditionVariable?.bgType === "none" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, main: { ...mainStyle?.backgroundStyles[`main`], bgType: "none" }, mobile_main: { ...mainStyle?.backgroundStyles[`mobile_main`], bgType: "none" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>None</div>
                                        <div className={`${conditionVariable?.bgType === "solid" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, main: { ...mainStyle?.backgroundStyles[`main`], bgType: "solid" }, mobile_main: { ...mainStyle?.backgroundStyles[`mobile_main`], bgType: "solid" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>Solid</div>
                                        <div className={`${conditionVariable?.bgType === "gradient" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, main: { ...mainStyle?.backgroundStyles[`main`], bgType: "gradient" }, mobile_main: { ...mainStyle?.backgroundStyles[`mobile_main`], bgType: "gradient" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>Gradient</div>
                                        <div className={`${conditionVariable?.bgType === "image" ? "bg-light-primary active-on" : ""} cursor-pointer rounded`} onClick={() => setMainStyle({ ...mainStyle, backgroundStyles: { ...mainStyle?.backgroundStyles, main: { ...mainStyle?.backgroundStyles[`main`], bgType: "image" }, mobile_main: { ...mainStyle?.backgroundStyles[`mobile_main`], bgType: "image" } } })} style={{ padding: "0.25rem 1rem", transition: "0.25s ease" }}>Image</div>
                                    </>
                                ) : type === "btnSetting" ? (
                                    <>
