    ...
    return (
        <>
            <Row className="customer-basic-details  ">
                ...
                <Col xs={6} md={3} xl={2} className={`d-flex align-items-center m-auto justify-content-center border-0 rounded btn ${currentStep === 3 ? 'active btn-primary' : ''}`} onClick={() => NavCurrentStep(3)}><User size={18} style={{paddingRight:''}}/>Identity Proof Information</Col>
