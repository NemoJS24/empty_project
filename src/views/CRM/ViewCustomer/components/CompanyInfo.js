                    ...
                    <Col md='4'>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="industry"
                          type="text"
                          value={userData?.associated_accounts[0]?.industry}
                          disabled={!editMode}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
                    ...
                    <Col md='4'>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="cust_gst_no"
                          type="text"
                          value={userData?.associated_accounts[0]?.company_gst}
                          disabled={!editMode}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
                    ...
                    <Col md='4'>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="company_phone"
                          type="number"
                          value={userData?.associated_accounts[0]?.company_phone}
                          disabled={!editMode}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
                    ...
                    <Col md='4'>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          name="company_email"
                          type="email"
                          value={userData?.associated_accounts[0]?.company_email}
                          disabled={!editMode}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
                    ...
                    <Col md='4'>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          type="text"
                          value={userData?.associated_accounts[0]?.company_website}
                          disabled={!editMode}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
                    ...
                    <Col md='4'>
                      <FormGroup>
                        ...
                        <Input
                          ...
                          type="text"
                          value={userData?.associated_accounts[0]?.company_pancard}
                          disabled={!editMode}
                          onChange={handleInputChange}
                        />
                      </FormGroup>
